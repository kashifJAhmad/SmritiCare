...
export async function initDatabase(): Promise<IDatabase> {
  ...
  // Try loading native expo-sqlite safely without
  ...
  try {
    ...
    console.log(
      'SmritiCare: ExpoSQLite native module not present, using persistent storage engine.',
    );
  }

  // Persistent AsyncStorage storage engine for
  // Expo Go and Web.
  const fallback =
    new PersistentDatabaseFallback();
