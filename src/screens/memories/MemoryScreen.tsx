      ...
      <View style={styles.container}>
        ...
        <View style={styles.bottomNav}>
          ...
          <Pressable
            style={[
              styles.navItem,
              activeTab === 'Games' && styles.activeNavItem,
            ]}
          ...
          >
            ...
            <Text
              style={[
                styles.navText,
                activeTab === 'Games' && styles.activeNavText,
              ]}
            >
              Games
            </Text>
          ...
          <Pressable
            style={[
              styles.navItem,
              activeTab === 'Remind' && styles.activeNavItem,
            ]}
          ...
          >
            ...
            <Text
              style={[
                styles.navText,
                activeTab === 'Remind' && styles.activeNavText,
              ]}
            >
              Remind
            </Text>
          ...
          <Pressable
            style={[
              styles.navItem,
              activeTab === 'Memory' && styles.activeNavItem,
            ]}
          ...
          >
            ...
            <Text
              style={[
                styles.navText,
                activeTab === 'Memory' && styles.activeNavText,
              ]}
            >
              Memory
            </Text>
